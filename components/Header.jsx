...
const { cartItems } = useSelector((state) => state.cart);
    ...
    return <header className={'w-full h-[50px] md:h-[80px]  flex bg-white items-center justify-between z-20 sticky top-0 transition-transform duration-300 ${show}'}>
     <Wrapper className="h-[60px] flex justify-between items-center">
     <Link href="/">
     <img src="/logo-2.png" alt="logo" className="w-[120px] md:w-[120px]"/>
      ...
      hover:bg-black/[0.05] cursor-pointer relative">
        ...
        <div className="h-[14px] md:h-[18px] min-w-[14px] md:min-w-[18px] rounded-full
         bg-red-600 absolute top-1 left-5 md:left-7 text-white text-[10px] Md:text-[12px]
          flex justify-center items-center px-[2px] md:px-[5]">
          131
          </div>
      </div>
      {/* icon-end */}
